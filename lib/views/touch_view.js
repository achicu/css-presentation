...
(function() {
    ...
    Touch.preview = true;
    Touch.previewStorageKey = "TouchPreview";
    if (window.localStorage) {
        var localStorageConfig = window.localStorage.getItem(Touch.previewStorageKey);
        if (localStorageConfig == "no")
            Touch.preview = false;
    }
    ...
    Touch.togglePreview = function() {
        ...
        if (window.localStorage)
            window.localStorage.setItem(Touch.previewStorageKey, Touch.preview ? "yes" : "no");
    };

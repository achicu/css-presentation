...
(function(){
    function FilterStoreView(filterStore, filterList, filterListView, shaderEditor, type, dockPanel) {
        ...
        this.dockPanel = dockPanel || new Global.DockPanel(this.type.name);

...
(function(){
    function FilterStoreView(filterStore, filterList, filterListView, shaderEditor, type, parentEl) {
        ...
        if (parentEl) {
            this.filterStockEl.appendTo(parentEl);
        } else {
            this.dockPanel = new Global.DockPanel(this.type.name);
            this.filterStockEl.appendTo(this.dockPanel.el);
        }
    ...
    $.extend(FilterStoreView.prototype, {
        ...
        onFilterDeleted: function(filterConfig){
            ...
            if (this.shaderEditor && this.shaderEditor.filter && this.shaderEditor.filter.name === filterConfig.name){

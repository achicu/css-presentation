...
(function() {
    ...
    $.extend(State.prototype, {
        ...
        prepare: function(oldState) {
            this.clearAdvanceTimer();
            if (this.advance == "auto")
                this.advanceTimer = setTimeout(this.onAdvanceTimerCallback.bind(this), oldState.time * 1000);
        },

        onAdvanceTimerCallback: function() {
            this.clearAdvanceTimer();
            this.slideView.animationEnd();
        },
    ...
    $.extend(SlideView.prototype, {
        ...
        animationEnd: function() {
            this.setState(this.currentState + 1, 1, false);
        },
        ...
        findState: function(index, direction, skipAuto) {
            ...
            for (; index >= 0 && index < this.states.length; index += direction) {
                ...
                if (state) {
                    if (skipAuto && state.advance == "auto")
                        continue;
                    return state;
                }
            }

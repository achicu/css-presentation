...
(function() {
    function SlidesListView(presenter, slides) {
        ...
        this.infoView.el.addClass("presenter-info-bar").append(this.infoBarEl);
        this.infoBarView = Global.TemplateView.convert(this.infoBarEl);
        this.infoView.on("visibilitychanged", this.onInfoViewSlideVisiblityChanged.bind(this));
    ...
    $.extend(SlidesListView.prototype, {
        ...
        updateHash: function(name) {
            ...
            this.presenter.slideChanged(oldName, name);
        },
        ...
        onInfoViewSlideVisiblityChanged: function() {
            this.presenter.infoBarVisibilityChanged();
            this.updateSlideNumber();
        },

        updateSlideNumber: function() {
            if (this.infoView.visible)
                this.infoBarView.slideNumberView.el.text(this.scrollView.selectedIndex + 1);
        }
    });

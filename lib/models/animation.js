...
(function() {
    ...
    $.extend(Animation.prototype, {
        ...
        getCSSFilters: function() {
            var time = this.currentTime(),
                filterProperty = this.getFiltersAtTime(time);
            return filterProperty.join(" ");
        },
        ...
        loadAnimation: function(animation) {
            this.ignoreSaves();
            this.reset();
            this.metadata = animation.metadata || {};
            this.imageUrl = animation.imageUrl;

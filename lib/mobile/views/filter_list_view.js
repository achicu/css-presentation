...
(function() {
    ...
    function FilterListView(mainView, filterList, filterStore) {
        ...
        this.titleView.el.addClass("filter-list-view-title").text("Select filter");
    ...
    $.extend(FilterListView.prototype, {
        addFilterBox: function(filterConfig) {
            ...
            filterView.el.prepend($("<div />").addClass("filter-preview").css("-webkit-filter", filterConfig.generatePreviewCode()));
        },

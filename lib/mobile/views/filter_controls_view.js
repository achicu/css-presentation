...
(function() {
    ...
    $.extend(FilterControlsView.prototype, {
        ...
        updateTransform: function() {
            this.el.css({
                "-webkit-transform": "translate3d(0, " + (this.containerView.height() - this.filterListView.innerHeight() - this.innerHeight()) + "px, 0px)",
                "opacity": 1
            });
        },
        ...
        show: function(withTransform, quick) {
            ...
            if (withTransform) {
                this.el.css("-webkit-transform", "translate3d(0, " + (this.containerView.height() - this.filterListView.innerHeight()) + "px, 0px)");
        ...
        hide: function(withTransform, destroy) {
            if (!this.visible)
                return;
            this.visible = false;
            this.css({
            ...
            if (withTransform)
                this.el.css("-webkit-transform", "translate3d(0, " + this.containerView.height() + "px, 0px)");
            var self = this;
            ...
            this.removalTimer = setTimeout(function() {
                if (destroy) {
                    ...
                    self.el.css("-webkit-transform", "translate3d(10000px, 10000px, 0px)");
                }
            }, 300);
        },

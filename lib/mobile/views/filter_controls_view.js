    ...
    $.extend(FilterControlsView.prototype, {
        ...
        updateTransform: function() {
            this.el.css(Global.Utils.prefix({
                "transform": "translate3d(0, " + (- this.innerHeight()) + "px, 0px)",
                "opacity": 1
            }));
        },
        ...
        show: function() {
            ...
            this.visible = true;
            this.el.css(Global.Utils.prefix({
                "transition": Global.Utils.prefixValue("transform 0.2s linear, opacity 0.1s linear"),
                "opacity": 0,
        ...
        hide: function(destroy) {
            ...
            this.css(Global.Utils.prefix({
                "transition": Global.Utils.prefixValue("transform 0.3s linear, opacity 0.2s linear"),
                "transform": "translate3d(0px, 0px, 0px)",
                "opacity": 0
            }));
            var self = this;

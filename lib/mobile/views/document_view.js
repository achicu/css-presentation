...
(function() {
    ...
    $.extend(DocumentView.prototype, {
        onTansformChange: function(transform) {
            ...
            if (this.filterListView.filterControlsView)
                this.filterListView.filterControlsView.hide();
        ...
        onTansformEnd: function(transform) {
            ...
            if (this.filterListView.filterControlsView)
                this.filterListView.filterControlsView.show(false);
        ...
        restoreView: function() {
            ...
            setTimeout(function() {
                ...
                self.filterListView.el.css({
                    "-webkit-transition": "opacity 0.1s linear",
                    "opacity": 1
                });
                if (self.filterListView.filterControlsView)
                    self.filterListView.filterControlsView.show(false);

...
(function() {
    ...
    function DocumentView(mainView, filterList, animation) {
        ...
        this.el.addClass("document-view").css("-webkit-transform", "translate3d(10000px, 10000px, 0px)");
        this.fillParent();
        ...
        this.uiView.el.addClass("document-ui-view").css({
            "width": "100%",
            "height": "100%"
        });
        ...
        this.listButtonView.el.addClass("list-button-view").css({
            "position": "absolute",
        ...
        this.controlsPlaceholderView.el.css({
            "position": "absolute",
            "width": "100%",
            "bottom": "100px"
        });

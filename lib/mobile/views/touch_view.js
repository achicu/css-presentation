...
(function() {
	...
	$.extend(TouchView.prototype, {
		setTouchParent: function(parent) {
			this.touchParent = parent;
		},
		...
		installTouchTrackingEvents: function() {
			...
			$(window)
				...
				.bind("touchcancel", this.touchEvents.onTouchCancel);
		},
		...
		removeTouchTrackingEvents: function() {
			...
			$(window)
				...
				.unbind("touchcancel", this.touchEvents.onTouchCancel);
		},
		...
		onTouchCancel: function(event) {
			event.preventDefault();
			if (TouchView.captureTouchSurface && (TouchView.captureTouchSurface !== this)) {
				TouchView.captureTouchSurface.onTouchCancel(event);
				return;
			}
			var touches = event.originalEvent.changedTouches;
			var list = [];

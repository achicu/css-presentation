...
(function() {
    ...
    $.extend(HorizontalLayout.prototype, {
        ...
        layout: function() {
            var left = 0, height = 0;
            var fillers = [], fillSum = 0, canResizeHeight = true;
            this.view.forEachChild(function(childView) {
                ...
                if (childView.fillWidth) {
                    ...
                    left += childView.margin("left") + childView.margin("right");
                    return;
                }
            ...
            if (fillers.length) {
                ...
                var width = this.view.elementWidth();
                ...
                this.view.forEachChild(function(childView) {
                    ...
                    if (childView.fillWidth) {
                        ...
                        width += childView.margin("left") + childView.margin("right");
                    } else {

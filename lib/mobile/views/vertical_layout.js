...
(function() {
    ...
    $.extend(VerticalLayout.prototype, {
        ...
        layout: function() {
            var top = 0, width = 0;
            var fillers = [], fillSum = 0, canResizeWidth = true, prevSibilingMargin = 0;
            this.view.forEachChild(function(childView) {
                ...
                top += childView.heightWithMargnCollapsing(prevSibilingMargin);
            ...
            if (fillers.length) {
                ...
                this.view.forEachChild(function(childView) {
                    ...
                    if (childView.fillHeight) {
                        ...
                        height = childView.heightWithMargnCollapsing(prevSibilingMargin);
                    }
                    top += height;
                    prevSibilingMargin = childView.margin("bottom");
                    width = Math.max(width, childView.width());

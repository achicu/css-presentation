    ...
    RenderSurfaceView.prototype = {
        ...
        updateChildren: function() {
            ...
            if (this.leftDock) {
                ...
                this.leftDock.el.css("-webkit-transform", "translate3d(" + (-size) + "px, 0px, 0px)");
            }
            this.mainEl.css("-webkit-transform", "translate3d(0px, 0px, 0px)");
            if (this.rightDock) {
                size = this.mainEl.outerWidth();
                this.rightDock.el.css("-webkit-transform", "translate3d(" + size + "px, 0px, 0px)");
            }
        },
        ...
        updateOffset: function() {
            if (!this.hadFirstLayout)
                this.updateChildren();
            this.transformLayerEl.css("-webkit-transform", "translate3d(" + (-this.offset) + "px, 0px, 0px)");
        },

    ...
    $.extend(StepScrollView.prototype, {
        updateStepPoints: function() {
            ...
            this.contentView.forEachChild(function(view) {
                ...
                stepPoints.push({
                    view: view,
                    x: collectX ? (rect.left + rect.width / 2 - parentRect.left) : 0, 
                    y: collectY ? (rect.top + rect.height / 2 - parentRect.top) : 0
                });
            });
        },
        ...
        prev: function() {
            this.setScrollIndex(this.selectedIndex - 1);
        },
        ...
        onScrollViewResized: function() {
            this.setScrollIndex(this.selectedIndex, false);
        }
    });

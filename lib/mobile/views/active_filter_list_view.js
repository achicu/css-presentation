...
(function() {
    ...
    $.extend(ActiveFilterListView.prototype, {
        ...
        relayout: function() {
            ActiveFilterListView.$super.prototype.relayout.call(this);
        ...
        onListViewScroll: function(delta) {
            ...
            this.dragView.el.toggleClass("covered",  x < this.minListViewX);
            this.addFilterButtonView.el.toggleClass("covered", x > this.maxListViewX);
        }
    });

...
(function() {
    ...
    $.extend(ActiveFilterListView.prototype, {
        ...
        updateBottomButtons: function(delta, useAnimation) {
            ...
            var transitionDragView = "",
                transitionAddFilterButtonView = "";
            if (!this.firstButtonsUpdate && useAnimation && delta.x) {
                ...
                if (timeDragView > 0)
                    transitionDragView = Global.Utils.prefixOne("transform") + " " + (timeDragView / 1000) + "s linear";
                if (timeAddFilterButtonView > 0)
                    transitionAddFilterButtonView = Global.Utils.prefixOne("transform") + " " + (timeAddFilterButtonView / 1000) + "s linear";
            }
            this.dragView.el.css(Global.Utils.prefix({
                "transform": "translate3d(" + dragViewX + "px, 0px, 1px)",
                "transition": transitionDragView
            }));
            this.addFilterButtonView.el.css(Global.Utils.prefix({
                "transform": "translate3d(" + addFilterButtonViewX + "px, 0px, 1px)",
                "transition": transitionAddFilterButtonView
            }));

            this.firstButtonsUpdate = false;
        },

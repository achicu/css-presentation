...
(function() {
    ...
    function ScrollView(type) {
        ...
        this.contentEl = this.contentView.el.css(Global.Utils.prefix({
    ...
    $.extend(ScrollView.prototype, {
        ...
        onAnimationFrame: function() {
            ...
            if (!this.moveTransform)
                return;
            if (this.fire("scroll", [this.moveTransform]))
                return;
            this.contentEl.css(Global.Utils.prefixOne("transform"), "translate3d(" + this.moveTransform.dragX + "px, " + this.moveTransform.dragY + "px, 1px) " + this.startTransform);
            this.moveTransform = null;
        },

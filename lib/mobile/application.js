...
(function() {
    function Application() {
        ...
        touchLayerTest.touchParent = parentImageView;
        ...
        for (var i = 0; i < 10; ++i) {
            ...
            touchLayer.touchParent = touchLayerTest;
            touchLayer.el.css("display", "inline-block");
            touchLayer.el.css("-webkit-writing-mode", "horizontal-tb");
            touchLayer.el.css("height", "400px");
            for (var j = 0; j < 15; j++) {
                touchLayer.contentEl.append(
                    $("<div style='width: 100px; height: 80px; border-radius: 5px; text-align: center; padding-top: 20px; background-color: white; margin-bottom: 5px' />").html("<b>" + i + "</b><br />" + j)
                );
            }

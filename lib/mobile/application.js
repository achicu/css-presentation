...
(function() {
    function Application() {
        ...
        parentImageView.setLayout(new Global.VerticalLayout());

        var mainView = new Global.View();
        mainView.el.css({
            "width": "100%",
            "background-color": "green",
            "margin-bottom": "10px"
        }).html("Content bar");
        mainView.fillHeight = 1;
        parentImageView.append(mainView);
        ...
        parentImageView.append(touchLayerTest);
        touchLayerTest.contentView.setLayout(new Global.HorizontalLayout());
        ...
        for (var i = 0; i < 10; ++i) {
            ...
            itemWithTouch1.el.css("margin-left", "5px");
            itemWithTouch1.el.css("margin-right", "5px");
            ...
            touchLayerTest.contentView.append(itemWithTouch1);
        }

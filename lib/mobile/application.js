...
(function() {
    function Application() {
        ...
        touchLayerTest.on("touchtransform", function(transform) {
            elTransform.x = transform.dragX;
            elTransform.y = transform.dragY;
            elTransform.scale = transform.scale;
            elTransform.rotation = transform.rotation;
            rotEl.css("-webkit-transform",
                "translate(" + (transform.originX) + "px, " + (transform.originY) + "px) " +
                generateTransform(elTransform) +
                " translate(" + (-transform.originX) + "px, " + (-transform.originY) + "px) " +
                startTransform
            );
        });
        ...
        touchLayerTest.on("touchdragmove", function(transform, touch) {
            elTransform.x = transform.dragX;
            elTransform.y = transform.dragY;
            rotEl.css("-webkit-transform", generateTransform(elTransform) + startTransform);
        });

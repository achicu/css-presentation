...
(function() {
    function Application() {
        ...
        this.builtinFilterStoreView = new Global.FilterStoreView(this.filterStore, this.filterList, null, null, "builtins");

        this.renderSurfaceView = new Global.RenderSurfaceView(this);
        this.renderSurfaceView.installLeftDock(this.builtinFilterStoreView.dockPanel);

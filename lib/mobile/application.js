...
(function() {
    function Application() {
        ...
        for (var i = 0; i < 10; ++i)
            touchLayerTest.contentEl.append("<img style='display: inline-block' src='http://html.adobe.com/_/img/slides/edgeinspect/slides_edgeinspect_video.png' width='100px' height='100px' />");

        touchLayerTest.setScrollIndex(0, false);

        // var touchLayerTest2 = new Global.ScrollView(Global.ScrollView.HORIZONTAL);
        // touchLayerTest2.el.css({
        //     "width": "50%",
        //     "height": "100%",
        //     "position": "absolute",
        //     "left": "50%",
        //     "top": "0px"
        // }).appendTo(document.body);
        // touchLayerTest2.contentEl.css("width", "1500px");
        // touchLayerTest2.contentEl.append("<img src='http://html.adobe.com/_/img/slides/edgeinspect/slides_edgeinspect_video.png' width='1500px' />");
    }
